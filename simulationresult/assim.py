...
df = sns.load_dataset('assim',data_home='/Users/liyahui/work/PycharmProjects/dataVisualization/simulationresult/',cache=True)
...
plt.savefig('assim.png', transparent=True,dpi = 600)
plt.show()