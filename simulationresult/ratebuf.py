...
df = sns.load_dataset('bufrate',data_home='/Users/liyahui/work/PycharmProjects/dataVisualization/simulationresult/',cache=True)
...
plt.savefig('ratebuf.png', transparent=True,dpi = 600)
plt.show()